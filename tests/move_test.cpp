...
const auto moveConstructorTestParams = ::testing::Values(
	...
	MoveConstructorTestParams{Position{2, 2}, Position{2, 3}, PieceType::PAWN, Color::WHITE, PieceType::QUEEN, std::nullopt, SpecialMove::NONE, CastleRights{true, true}, CastleRights{true, true}, 0, 1},
	MoveConstructorTestParams{Position{4, 4}, Position{4, 5}, PieceType::KNIGHT, Color::BLACK, PieceType::KING, Position{4, 6}, SpecialMove::DOUBLE_PAWN_PUSH, CastleRights{false, true}, CastleRights{true, true}, 4, 10}
);
