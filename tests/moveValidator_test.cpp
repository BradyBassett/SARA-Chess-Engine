...
const auto invalidValidateMoveTestParams = ::testing::Values(
	...
	// Invalid pawn moves
	InvalidValidateMoveTestParams{"rnbqkbnr/pppppppp/8/8/8/2P5/P1P3PP/4KBNR w kq - 0 1", Position{Utility::convertStringToPosition("c2")}, Position{Utility::convertStringToPosition("e5")}, PieceType::PAWN, Color::WHITE, "Invalid move - The piece cannot move to the to square"},
	InvalidValidateMoveTestParams{"rnbqkbnr/pppppppp/8/8/8/2P5/P1P3PP/4KBNR w kq - 0 1", Position{Utility::convertStringToPosition("c2")}, Position{Utility::convertStringToPosition("c1")}, PieceType::PAWN, Color::WHITE, "Invalid move - The piece cannot move to the to square"},
	InvalidValidateMoveTestParams{"rnbqkbnr/pppppppp/8/8/8/2P5/P1P3PP/4KBNR w kq - 0 1", Position{Utility::convertStringToPosition("c2")}, Position{Utility::convertStringToPosition("d1")}, PieceType::PAWN, Color::WHITE, "Invalid move - The piece cannot move to the to square"},
	InvalidValidateMoveTestParams{"rnbqkbnr/pppppppp/8/8/8/2P5/P1P3PP/4KBNR w kq - 0 1", Position{Utility::convertStringToPosition("c2")}, Position{Utility::convertStringToPosition("c4")}, PieceType::PAWN, Color::WHITE, "Invalid move - The path is not clear"},
	...
	InvalidValidateMoveTestParams{"r3kbnr/p1p1pppp/2p5/8/8/8/PPPPPPPP/RNBQKBNR b KQkq - 0 1", Position{Utility::convertStringToPosition("a7")}, Position{Utility::convertStringToPosition("a4")}, PieceType::PAWN, Color::BLACK, "Invalid move - The piece cannot move to the to square"},
	InvalidValidateMoveTestParams{"r3kbnr/p1p1pppp/2p5/8/8/8/PPPPPPPP/RNBQKBNR b KQkq - 0 1", Position{Utility::convertStringToPosition("c7")}, Position{Utility::convertStringToPosition("c8")}, PieceType::PAWN, Color::BLACK, "Invalid move - The piece cannot move to the to square"},
	InvalidValidateMoveTestParams{"r3kbnr/p1p1pppp/2p5/8/8/8/PPPPPPPP/RNBQKBNR b KQkq - 0 1", Position{Utility::convertStringToPosition("c7")}, Position{Utility::convertStringToPosition("d8")}, PieceType::PAWN, Color::BLACK, "Invalid move - The piece cannot move to the to square"},
	InvalidValidateMoveTestParams{"r3kbnr/p1p1pppp/2p5/8/8/8/PPPPPPPP/RNBQKBNR b KQkq - 0 1", Position{Utility::convertStringToPosition("c7")}, Position{Utility::convertStringToPosition("c5")}, PieceType::PAWN, Color::BLACK, "Invalid move - The path is not clear"},
	...
	InvalidValidateMoveTestParams{"k3r3/5P2/3p3P/2P3b1/PR4P1/1K4N1/2P3Pp/1b6 w - - 0 1", Position{Utility::convertStringToPosition("g3")}, Position{Utility::convertStringToPosition("e5")}, PieceType::KNIGHT, Color::WHITE, "Invalid move - The piece cannot move to the to square"},
	InvalidValidateMoveTestParams{"2k3K1/3p4/1n4N1/p4p2/2p1R3/1QP1Bp2/pPb5/8 w - - 0 1", Position{Utility::convertStringToPosition("g6")}, Position{Utility::convertStringToPosition("f7")}, PieceType::KNIGHT, Color::WHITE, "Invalid move - The piece cannot move to the to square"},
	InvalidValidateMoveTestParams{"2k3K1/3p4/1n4N1/p4p2/2p1R3/1QP1Bp2/pPb5/8 b - - 0 1", Position{Utility::convertStringToPosition("b6")}, Position{Utility::convertStringToPosition("e4")}, PieceType::KNIGHT, Color::BLACK, "Invalid move - The piece cannot move to the to square"},
	InvalidValidateMoveTestParams{"8/p1N2r2/K7/1n1qRpB1/p5k1/4p2b/4P1n1/4R3 b - - 0 1", Position{Utility::convertStringToPosition("g2")}, Position{Utility::convertStringToPosition("a3")}, PieceType::KNIGHT, Color::BLACK, "Invalid move - The piece cannot move to the to square"},
	// Invalid bishop moves
	InvalidValidateMoveTestParams{"8/p1N2r2/K7/1n1qRpB1/p5k1/4p2b/4P1n1/4R3 w - - 0 1", Position{Utility::convertStringToPosition("g5")}, Position{Utility::convertStringToPosition("g6")}, PieceType::BISHOP, Color::WHITE, "Invalid move - The piece cannot move to the to square"},
	InvalidValidateMoveTestParams{"8/p1N2r2/K7/1n1qRpB1/p5k1/4p2b/4P1n1/4R3 w - - 0 1", Position{Utility::convertStringToPosition("g5")}, Position{Utility::convertStringToPosition("f3")}, PieceType::BISHOP, Color::WHITE, "Invalid move - The piece cannot move to the to square"},
	InvalidValidateMoveTestParams{"8/p1N2r2/K7/1n1qRpB1/p5k1/4p2b/4P1n1/4R3 b - - 0 1", Position{Utility::convertStringToPosition("h3")}, Position{Utility::convertStringToPosition("h8")}, PieceType::BISHOP, Color::BLACK, "Invalid move - The piece cannot move to the to square"},
	InvalidValidateMoveTestParams{"8/p1N2r2/K7/1n1qRpB1/p5k1/4p2b/4P1n1/4R3 b - - 0 1", Position{Utility::convertStringToPosition("h3")}, Position{Utility::convertStringToPosition("g1")}, PieceType::BISHOP, Color::BLACK, "Invalid move - The piece cannot move to the to square"},
	InvalidValidateMoveTestParams{"rnbqk1nr/ppp1pp2/6p1/3p1b2/1P2B2p/5P2/PPPPP2P/RNBQK1NR w KQkq - 0 1", Position{Utility::convertStringToPosition("e4")}, Position{Utility::convertStringToPosition("c6")}, PieceType::BISHOP, Color::WHITE, "Invalid move - The path is not clear"},
	InvalidValidateMoveTestParams{"rnbqk1nr/ppp1pp2/6p1/3p1b2/1P2B2p/5P2/PPPPP2P/RNBQK1NR w KQkq - 0 1", Position{Utility::convertStringToPosition("e4")}, Position{Utility::convertStringToPosition("g2")}, PieceType::BISHOP, Color::WHITE, "Invalid move - The path is not clear"},
	InvalidValidateMoveTestParams{"rnbqk1nr/ppp1pp2/6p1/3p1b2/1P2B2p/5P2/PPPPP2P/RNBQK1NR b KQkq - 0 1", Position{Utility::convertStringToPosition("f5")}, Position{Utility::convertStringToPosition("d3")}, PieceType::BISHOP, Color::BLACK, "Invalid move - The path is not clear"},
	InvalidValidateMoveTestParams{"rnbqk1nr/ppp1pp2/6p1/3p1b2/1P2B2p/5P2/PPPPP2P/RNBQK1NR b KQkq - 0 1", Position{Utility::convertStringToPosition("f5")}, Position{Utility::convertStringToPosition("h7")}, PieceType::BISHOP, Color::BLACK, "Invalid move - The path is not clear"},
	// Invalid rook moves
	InvalidValidateMoveTestParams{"8/n2P4/8/2kP4/r3pBpr/P5Kb/6pp/Q3R3 w - - 0 1", Position{Utility::convertStringToPosition("e1")}, Position{Utility::convertStringToPosition("c3")}, PieceType::ROOK, Color::WHITE, "Invalid move - The piece cannot move to the to square"},
	InvalidValidateMoveTestParams{"8/n2P4/8/2kP4/r3pBpr/P5Kb/6pp/Q3R3 w - - 0 1", Position{Utility::convertStringToPosition("e1")}, Position{Utility::convertStringToPosition("f3")}, PieceType::ROOK, Color::WHITE, "Invalid move - The piece cannot move to the to square"},
	InvalidValidateMoveTestParams{"8/n2P4/8/2kP4/r3pBpr/P5Kb/6pp/Q3R3 b - - 0 1", Position{Utility::convertStringToPosition("a4")}, Position{Utility::convertStringToPosition("d1")}, PieceType::ROOK, Color::BLACK, "Invalid move - The piece cannot move to the to square"},
	InvalidValidateMoveTestParams{"8/n2P4/8/2kP4/r3pBpr/P5Kb/6pp/Q3R3 b - - 0 1", Position{Utility::convertStringToPosition("h4")}, Position{Utility::convertStringToPosition("f5")}, PieceType::ROOK, Color::BLACK, "Invalid move - The piece cannot move to the to square"},
	InvalidValidateMoveTestParams{"1nbqkbnr/ppp1pppp/3p4/3rR3/4P3/8/PPPP1PPP/RNBQKBN1 w Qk - 0 1", Position{Utility::convertStringToPosition("e5")}, Position{Utility::convertStringToPosition("e3")}, PieceType::ROOK, Color::WHITE, "Invalid move - The path is not clear"},
	InvalidValidateMoveTestParams{"1nbqkbnr/ppp1pppp/3p4/3rR3/4P3/8/PPPP1PPP/RNBQKBN1 w Qk - 0 1", Position{Utility::convertStringToPosition("e5")}, Position{Utility::convertStringToPosition("c5")}, PieceType::ROOK, Color::WHITE, "Invalid move - The path is not clear"},
	InvalidValidateMoveTestParams{"1nbqkbnr/ppp1pppp/3p4/3rR3/4P3/8/PPPP1PPP/RNBQKBN1 b Qk - 0 1", Position{Utility::convertStringToPosition("d5")}, Position{Utility::convertStringToPosition("f5")}, PieceType::ROOK, Color::BLACK, "Invalid move - The path is not clear"},
	InvalidValidateMoveTestParams{"1nbqkbnr/ppp1pppp/3p4/3rR3/4P3/8/PPPP1PPP/RNBQKBN1 b Qk - 0 1", Position{Utility::convertStringToPosition("d5")}, Position{Utility::convertStringToPosition("d7")}, PieceType::ROOK, Color::BLACK, "Invalid move - The path is not clear"},
	// Invalid queen moves
	InvalidValidateMoveTestParams{"8/8/2pQ3K/qP1P4/1PP5/6n1/bN2rR1N/4k1r1 w - - 0 1", Position{Utility::convertStringToPosition("d6")}, Position{Utility::convertStringToPosition("e4")}, PieceType::QUEEN, Color::WHITE, "Invalid move - The piece cannot move to the to square"},
	InvalidValidateMoveTestParams{"8/8/2pQ3K/qP1P4/1PP5/6n1/bN2rR1N/4k1r1 w - - 0 1", Position{Utility::convertStringToPosition("d6")}, Position{Utility::convertStringToPosition("h3")}, PieceType::QUEEN, Color::WHITE, "Invalid move - The piece cannot move to the to square"},
	InvalidValidateMoveTestParams{"8/8/2pQ3K/qP1P4/1PP5/6n1/bN2rR1N/4k1r1 b - - 0 1", Position{Utility::convertStringToPosition("a5")}, Position{Utility::convertStringToPosition("b3")}, PieceType::QUEEN, Color::BLACK, "Invalid move - The piece cannot move to the to square"},
	InvalidValidateMoveTestParams{"8/8/2pQ3K/qP1P4/1PP5/6n1/bN2rR1N/4k1r1 b - - 0 1", Position{Utility::convertStringToPosition("a5")}, Position{Utility::convertStringToPosition("c8")}, PieceType::QUEEN, Color::BLACK, "Invalid move - The piece cannot move to the to square"},
	InvalidValidateMoveTestParams{"rnb1kbnr/p3p2p/p1pp1p1p/3qQ3/3PP3/8/PPP2PPP/RNBK1BNR w kq - 0 1", Position{Utility::convertStringToPosition("e5")}, Position{Utility::convertStringToPosition("c5")}, PieceType::QUEEN, Color::WHITE, "Invalid move - The path is not clear"},
	InvalidValidateMoveTestParams{"rnb1kbnr/p3p2p/p1pp1p1p/3qQ3/3PP3/8/PPP2PPP/RNBK1BNR w kq - 0 1", Position{Utility::convertStringToPosition("e5")}, Position{Utility::convertStringToPosition("e3")}, PieceType::QUEEN, Color::WHITE, "Invalid move - The path is not clear"},
	InvalidValidateMoveTestParams{"rnb1kbnr/p3p2p/p1pp1p1p/3qQ3/3PP3/8/PPP2PPP/RNBK1BNR w kq - 0 1", Position{Utility::convertStringToPosition("e5")}, Position{Utility::convertStringToPosition("c3")}, PieceType::QUEEN, Color::WHITE, "Invalid move - The path is not clear"},
	InvalidValidateMoveTestParams{"rnb1kbnr/p3p2p/p1pp1p1p/3qQ3/3PP3/8/PPP2PPP/RNBK1BNR w kq - 0 1", Position{Utility::convertStringToPosition("e5")}, Position{Utility::convertStringToPosition("g7")}, PieceType::QUEEN, Color::WHITE, "Invalid move - The path is not clear"},
	InvalidValidateMoveTestParams{"rnb1kbnr/p3p2p/p1pp1p1p/3qQ3/3PP3/8/PPP2PPP/RNBK1BNR b kq - 0 1", Position{Utility::convertStringToPosition("d5")}, Position{Utility::convertStringToPosition("f5")}, PieceType::QUEEN, Color::BLACK, "Invalid move - The path is not clear"},
	InvalidValidateMoveTestParams{"rnb1kbnr/p3p2p/p1pp1p1p/3qQ3/3PP3/8/PPP2PPP/RNBK1BNR b kq - 0 1", Position{Utility::convertStringToPosition("d5")}, Position{Utility::convertStringToPosition("d3")}, PieceType::QUEEN, Color::BLACK, "Invalid move - The path is not clear"},
	InvalidValidateMoveTestParams{"rnb1kbnr/p3p2p/p1pp1p1p/3qQ3/3PP3/8/PPP2PPP/RNBK1BNR b kq - 0 1", Position{Utility::convertStringToPosition("d5")}, Position{Utility::convertStringToPosition("b7")}, PieceType::QUEEN, Color::BLACK, "Invalid move - The path is not clear"},
	InvalidValidateMoveTestParams{"rnb1kbnr/p3p2p/p1pp1p1p/3qQ3/3PP3/8/PPP2PPP/RNBK1BNR b kq - 0 1", Position{Utility::convertStringToPosition("d5")}, Position{Utility::convertStringToPosition("d7")}, PieceType::QUEEN, Color::BLACK, "Invalid move - The path is not clear"},
	// Invalid king moves
	InvalidValidateMoveTestParams{"8/1N1k2r1/P5b1/1p4pp/Rp5Q/1n2K3/6pP/1B6 w - - 0 1", Position{Utility::convertStringToPosition("e3")}, Position{Utility::convertStringToPosition("g1")}, PieceType::KING, Color::WHITE, "Invalid move - The piece cannot move to the to square"},
	InvalidValidateMoveTestParams{"8/1N1k2r1/P5b1/1p4pp/Rp5Q/1n2K3/6pP/1B6 w - - 0 1", Position{Utility::convertStringToPosition("e3")}, Position{Utility::convertStringToPosition("e5")}, PieceType::KING, Color::WHITE, "Invalid move - The piece cannot move to the to square"},
	InvalidValidateMoveTestParams{"8/1N1k2r1/P5b1/1p4pp/Rp5Q/1n2K3/6pP/1B6 b - - 0 1", Position{Utility::convertStringToPosition("d7")}, Position{Utility::convertStringToPosition("d4")}, PieceType::KING, Color::BLACK, "Invalid move - The piece cannot move to the to square"},
	InvalidValidateMoveTestParams{"8/1N1k2r1/P5b1/1p4pp/Rp5Q/1n2K3/6pP/1B6 b - - 0 1", Position{Utility::convertStringToPosition("d7")}, Position{Utility::convertStringToPosition("f5")}, PieceType::KING, Color::BLACK, "Invalid move - The piece cannot move to the to square"},
